...
export default function ActionBtn({ type, value, icon, onCLick, sizeReset }) {
  const editClasses =
    ...
    <>
      <button
        ...
        className={`${
          ...
          sizeReset ? sizeReset : 'px-8 py-3 rounded-md'
        } box-border relative z-30 inline-flex items-center justify-center w-auto overflow-hidden font-bold transition-all duration-300 cursor-pointer group ring-offset-2 ring-1  ring-offset-indigo-200  ease focus:outline-none`}
      >
