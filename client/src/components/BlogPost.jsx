          ...
          return (
            <>
              <Fade top distance="20%" duration={1800} key={index}>
                <article className="blog-post-item | mx-auto shadow-lg mb-8 flex bg-black flex-col md:flex-row max-w-7xl">
                  ...
                  <div className="blog-text | p-5  text-white md:w-6/12">
                    <div className="date-time | flex gap-2 items-center text-sm text-[gold]">
