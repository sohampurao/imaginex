  ...
  return (
    <>
      <div className="partition-container | w-full min-h-[90vh] flex justify-center sm:gap-x-1 gap-x-[2px] overflow-hidden">
        ...
        >
          <div className="background-image | w-full h-full absolute top-0 left-0 bg-[url('/images/home/visualization.webp')] bg-no-repeat bg-center bg-cover"></div>
          <div className="inner-content | flex flex-col z-10 h-full w-full justify-center items-center backdrop-brightness-50 transition-all md:hover:backdrop-brightness-75">
        ...
        >
          <div className="background-image | w-full h-full absolute top-0 right-0 bg-[url('/images/home/virtualtour.webp')] bg-no-repeat bg-center bg-cover"></div>
          <div className="inner-content | flex flex-col z-10  h-full w-full justify-center items-center backdrop-brightness-50 transition-all md:hover:backdrop-brightness-75">
            <h1 className="capitalize text-lg sm:text-xl mb-10 font-bold tracking-wide leading-none text-white md:text-2xl lg:text-3xl">
              <Fade top cascade delay={300} duration={1300}>
                virtual 3D Tour
